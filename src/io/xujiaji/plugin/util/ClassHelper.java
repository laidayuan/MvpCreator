...
public class ClassHelper {
    ...
    public static void createContract(AnActionEvent e, EditEntity editEntity) {
        ...
        if (editEntity.isSinglePackage())
        {
            ...
            //classModel     = createClass(moduleDir, packageName, modelName); //暂不需要model
        ...
        //extendsClass(factory, searchScope, modelInterface, editEntity.getModelParent()); //model不继承基类
        ...
        openFiles(project, classContract, classPresenter, classView);
    }
...
//                System.out.println(pp.getTypeElement().getType().getPresentableText());
    ...
    private static void addExtendToPresenter(Project project, PsiElementFactory factory, GlobalSearchScope searchScope, PsiClass psiClass, String contractName, String modelName) {
        ...
        //extendsClass(factory, searchScope, psiClass, "BasePresenter<" + contractName + ".View," + modelName + ">");
        extendsClass(factory, searchScope, psiClass, "BasePresenter<" + contractName + ".View, " + contractName + ".Model>");
        searchAndImportClass("BasePresenter", psiClass, project);
        ...
        if (psiClasses.length > 1) {
            for (PsiClass pc :
                ...
                if (List.class.getPackage().getName().equals(packageName) ||
                        packageName.contains("com.yjd.library.mvp")) {
                    return pc;
                }
            }
        }
